...
def salva_offerta_sito(titolo, prezzo, negozio, scadenza, image_url, link_volantino):
    file_sito = "/home/antonio/sitoofferte/offerte.json"
    offerte = []
    ...
    os.makedirs("/home/antonio/sitoofferte", exist_ok=True)
...
async def richieste_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    file_path = '/home/antonio/sitoofferte/richieste_clienti.json'
...
async def ordini_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    file_path = '/home/antonio/sitoofferte/ordini.json'
    if not os.path.exists(file_path):
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        file_path = f"/home/antonio/sitoofferte/tubo_rosso.jpg"
