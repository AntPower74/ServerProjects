...
for idx, t in enumerate(tutti_turni):
    ...
    # Calcolo rigoroso, matematico e neutro
    ...
    if is_scorta:
        ...
        box_diff_text = f"• <b>&Delta; Nastro:</b> 0h 00m (Confermato {p_nastro}) | " \
                        ...
                        f"• <b>ATTIVITÀ:</b> Presidio rimessa a {dep} per copertura emergenze, guasti, sostituzioni e uscite vetture."
        ...
        nota_cambio_turno = "■ <b>CAMBIO CON:</b> Alle 11:45 a piazza Carlo Felice <b>CEDE IL BUS a To0710</b>. Rientro a Grugliasco in <b>AUTO AZIENDALE</b> alle 12:40."
    else:
        stato_header = "🔵 SCHEDA COMPARATIVA DI TURNO (DATI REALI)"
        box_diff_text = f"• <b>Nastro del Turno:</b> {p_nastro} | " \
                        f"• <b>Ore Lavoro (OLG):</b> {p_olg} | " \
                        f"• <b>Numero Riprese:</b> {p_rip}<br/>" \
                        f"• <b>INQUADRAMENTO:</b> Programma orario e sequenza corse conforme ai dati effettivi di esercizio nel Deposito di {dep}."
    ...
    t_diff.setStyle(TableStyle([('BACKGROUND', (0,0), (-1,0), colors.HexColor('#E2E3E5')), ('BACKGROUND', (0,1), (-1,1), colors.HexColor('#F8F9FA')), ('BOX', (0,0), (-1,-1), 1, colors.HexColor('#6C757D')), ('TOPPADDING', (0,0), (-1,-1), 1.5), ('BOTTOMPADDING', (0,0), (-1,-1), 1.5), ('LEFTPADDING', (0,0), (-1,-1), 4), ('RIGHTPADDING', (0,0), (-1,-1), 4)]))
    ...
    # DESTRA (PROPOSTA RIGOROSA)
    rows_prop = [
        [Paragraph(f"<b>🔵 NOSTRA SCHEDA COMPARATIVA</b><br/>Inizio: <b>{t['inizio']}</b> | Fine: <b>{p_fine}</b>", h_cell_p), Paragraph("", h_cell_p), Paragraph("", h_cell_p), Paragraph("", h_cell_p), Paragraph("", h_cell_p)],
    ...
    riga_tot_prop = f"<b>TOTALI PROPOSTA:</b> OLG: <font color='#004085'><b>{p_olg}</b></font> | Nastro: <font color='#004085'><b>{p_nastro}</b></font> | Riprese: <b>{p_rip}</b> | Pasti: <b>{p_pasto}</b>"
    ...
    t_right.setStyle(TableStyle([
        ...
        ('BOX', (0,-1), (-1,-1), 1, colors.HexColor('#004085')),
        ('GRID', (0,0), (-1,-2), 0.5, colors.HexColor('#DDDDDD')),
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO RIGENERATO: Approccio rigoroso, neutro, matematico e conforme al 100% alle regole impostate!")
