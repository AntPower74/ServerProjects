...
for idx, t in enumerate(tutti_turni):
    ...
    # DESTRA (Nostra Proposta CON IL BOX CAMBIO CON SUBITO SOTTO LA TABELLA)
    ...
    # NOTA CAMBIO CON INSERITA SUBITO SOTTO LA NOSTRA PROPOSTA (DESTRA)
    ...
    t_right.setStyle(TableStyle([
        ('SPAN', (0,0), (3,0)),
        ('SPAN', (0,-2), (3,-2)), # SPAN RIGA TOTALI
        ('SPAN', (0,-1), (3,-1)), # SPAN RIGA CAMBIO CON
        ...
        ('BACKGROUND', (0,-1), (-1,-1), colors.HexColor('#FFF3CD')), # SFONDO CAMBIO CON GIALLINO EVIDENTE
    ...
    # BOX LEGGE IN BASSO A TUTTA LARGHEZZA
    box_legge = [
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO AGGIORNATO CON IL NUOVO LAYOUT: 'CAMBIO CON:' SOTTO LA NOSTRA PROPOSTA E 'CCNL/LEGGE 138/58' IN BASSO!")
