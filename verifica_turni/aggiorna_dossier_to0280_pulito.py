...
for idx, t in enumerate(tutti_turni):
    ...
    if code == "To0280":
        # TO0280: 3 GIRI COMPLETI DI CASELLE + RIENTRO NATURALE A DEPOSITO GRUGLIASCO
        ...
        corse_prop_puntuali.append(["12:30", "13:00", "Trasf", "TO Carlo Felice -> TORINO DEPOSITO (Grugliasco)"])
        corse_prop_puntuali.append(["13:00", "13:10", "Disp", "Pulizia interna & Smonto a 8h00 piene (40h/sett)"])
        p_fine = "13:10"
        p_nastro = "8h 05m"
        p_olg = "8h 00m (40h)"
        p_rip = "1"
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO AGGIORNATO: Rimosso 'Raccordo' fittizio e inserito rientro reale TO Carlo Felice -> TORINO DEPOSITO Grugliasco!")
