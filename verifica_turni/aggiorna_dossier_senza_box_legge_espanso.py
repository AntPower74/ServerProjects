...
cambio_box_style = ParagraphStyle('CambioBox', fontName='Helvetica-Bold', fontSize=6.5, leading=8.0, textColor=colors.HexColor('#003366'))
...
for idx, t in enumerate(tutti_turni):
    ...
    # SINISTRA (Azienda - Spazio espanso e leggibile fino a 14 righe)
    rows_orig = [
    ...
    # DESTRA (Nostra Proposta - Spazio espanso e leggibile fino a 14 righe)
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO AGGIORNATO: Rimosso il box normativo in calce, cartellini espansi e puliti con massima leggibilità!")
