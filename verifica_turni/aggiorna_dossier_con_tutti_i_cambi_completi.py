...
# Mappa COMPLETA e UFFICIALE dei Cambi Turno (Carlo Felice, Porta Susa, Pinerolo, Perosa, Pont, Susa)
mappa_cambi_completa = {
    # PIAZZA CARLO FELICE (Navetta Caselle & Linee Torino)
    ...
    'To0280': "🔄 <b>CAMBIO CON:</b> Alle 11:45 a piazza Carlo Felice <b>CEDE IL BUS a To0710 / To0320</b> (che copre la corsa delle 12:00/12:30). Rientro a Grugliasco alle 12:40.",
...
for idx, t in enumerate(tutti_turni):
    ...
    # Box Cambi e Note Operative con la formula ufficiale "CAMBIO CON:"
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO AGGIORNATO CON LA NOTA 'CAMBIO CON:' SU TUTTE LE 156 SCHEDE!")
