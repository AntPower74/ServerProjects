...
pdf_out = "/home/antonio/verifica_turni/Comparazione turni 2025-2026/Dossier_Proposte_Cartellini_2026_Legge138.pdf"
...
law_style = ParagraphStyle('DocLaw', fontName='Helvetica-Bold', fontSize=8, leading=10, textColor=colors.HexColor('#990000'))
...
schede = [
    {
        ...
        "desc": "TURNO 213 DI PEROSA (LINEA EXTRAURBANA)",
        "violazione_l138": "Violazione L. 138/58 Art. 4 & 6: Nastro aziendale di 11h 35m con stacco passivo di quasi 4h e riposo giornaliero compresso.",
        "orig_inizio": "06:55", "orig_fine": "18:30", "orig_nastro": "11h 35m", "orig_olg": "7h 11m", "orig_rip": "3",
        "prop_inizio": "12:00", "prop_fine": "18:30", "prop_nastro": "6h 30m (CONFORME L. 138/58)", "prop_olg": "6h 20m", "prop_rip": "1",
        "motivo": "Corsa mattutina 07:10 ceduta a Pi0050, eliminando il vuoto e lo stacco diurno. Inizio a Perosa h 12:00, turno unico continuativo con riposo giornaliero di 17h30 garantito (Art. 6 L. 138/58).",
        "righe_orig": [
            ...
            ["---", "---", "STACCO", "STACCO IRREGOLARE DI 3h 50m A PEROSA"],
        ...
        "righe_prop": [
            ...
            ["-", "-", "-", "CONFORME L. 138/58: Turno Unico 6h30 - Zero Vuoti"]
        ]
    },
    {
        "turno": "Pt0030",
        "deposito": "PONT SAINT MARTIN",
        "desc": "CAREMA-TORINO-CAREMA (LINEA EXTRAURBANA)",
        "violazione_l138": "Violazione L. 138/58 Art. 4: Nastro di 12h 05m oltre ogni limite legale, con interruzione passiva di 4h 14m.",
        "orig_inizio": "06:28", "orig_fine": "18:33", "orig_nastro": "12h 05m", "orig_olg": "6h 43m", "orig_rip": "3",
        "prop_inizio": "12:40", "prop_fine": "18:33", "prop_nastro": "5h 53m (CONFORME L. 138/58)", "prop_olg": "5h 45m", "prop_rip": "1",
        "motivo": "Spezzone 06:28-08:33 ceduto a turno mattinale Ivrea/Pont. Inizio a Pont h 12:40, linea Torino/Chivasso/Ivrea e rientro a Pont Rimessa h 18:33 a nastro unico a norma di legge.",
        "righe_orig": [
            ...
            ["---", "---", "STACCO", "STACCO IRREGOLARE DI 4h 14m A PONT"],
        ...
        "righe_prop": [
            ...
            ["-", "-", "-", "CONFORME L. 138/58: Nastro ridotto da 12h05 a 5h53!"]
        ]
    },
    {
        "turno": "To0620",
        "deposito": "TORINO (GRUGLIASCO)",
        "desc": "TORINO-PINEROLO-TORINO (LINEA EXTRAURBANA)",
        "violazione_l138": "Violazione L. 138/58 Art. 4 & 5: Nastro di 10h 54m con fermata prolungata non computata in autostazione c.so Bolzano.",
        "orig_inizio": "06:15", "orig_fine": "17:09", "orig_nastro": "10h 54m", "orig_olg": "6h 49m", "orig_rip": "2",
        "prop_inizio": "06:15", "prop_fine": "14:00", "prop_nastro": "7h 45m (CONFORME L. 138/58)", "prop_olg": "6h 40m", "prop_rip": "1",
        "motivo": "Arrivo a Porta Susa h 09:30: cambio autista sul posto con auto aziendale da Grugliasco. Rientro del primo autista a Grugliasco e chiusura del turno a 7h45 a norma di legge.",
        "righe_orig": [
            ...
            ["---", "---", "STACCO", "STACCO IRREGOLARE DI QUASI 4h A PORTA SUSA"],
        ...
        "righe_prop": [
            ...
            ["-", "-", "-", "CONFORME L. 138/58: Nastro compatto 7h45 - Zero vuoti bus"]
        ]
    },
    {
        ...
        "violazione_l138": "Applicazione Art. 1, 2 e 7 Legge 138/1958: Raggiungimento 40h/settimana in 5 giorni con riposo compensativo di 48h consecutive (5+2).",
        ...
        "motivo": "Turno continuo Caselle Aeroporto a 8h00 piene giornaliere su 5 giorni (Lun-Ven = 40h00) -> Diritto legale a riposo compensativo fisso Sabato e Domenica.",
        "righe_orig": [
        ...
        "righe_prop": [
            ...
            ["-", "-", "-", "RIPOSO COMPENSATIVO EX L. 138/58: Sabato e Domenica (5+2)"]
        ]
    },
    {
...
for idx, s in enumerate(schede):
    ...
    head_t = Table([
        [
            Paragraph(f"<b>ARRIVA ITALIA (ex SADEM) - CONFRONTO TURNI EX L. 138/1958</b>", title_style),
    ...
    elements.append(Paragraph(f"<b>Riferimento Normativo:</b> <font color='#990000'>{s['violazione_l138']}</font>", law_style))
    elements.append(Spacer(1, 2))
...
doc.build(elements)
print("✅ Dossier PDF conforme alla Legge 138/1958 creato con successo!")
