...
def add_min(t_str, minutes):
    """Add minutes to time string '04.20' -> '04.10'"""
...
def main():
    ...
    # Column pairs for riprese: (Inizio col 0-idx, Fine col 0-idx)
    ...
    for i, row in enumerate(data):
        ...
        riprese = all_shifts[t_name]
        
        # Apply tempi accessori: -10 to first start, +10 to last end
        rips = [list(r) for r in riprese]
        rips[0][0] = add_min(rips[0][0], -10)
        rips[-1][1] = add_min(rips[-1][1], 10)
