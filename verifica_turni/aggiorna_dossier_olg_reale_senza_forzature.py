...
for idx, t in enumerate(tutti_turni):
    ...
    # REGOLA RIGOROSA: L'OLG DELLA PROPOSTA È PARI ALLE ORE DI LAVORO EFFETTIVAMENTE SVOLTE (SENZA FORZATURE ARTIFICIALI A 6h30)
    if is_40h:
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO AGGIORNATO: OLG fedele alle ore effettive di lavoro senza aumenti artificiali!")
