...
print(f"Generazione DOSSIER UNIFICATO COMPLETO per TUTTI i {len(tutti_turni)} turni (1 pagina per turno)...")
...
for idx, t in enumerate(tutti_turni):
    ...
    # Verifichiamo se è modificato o non modificato (già conforme)
    ...
    if is_40h:
        ...
        # Turni non modificati (già regolari/conformi)
    ...
    # 4. SOTTO: QUADRO NORMATIVO CCNL + L. 138/1958
    box_legge = [
        [
...
doc.build(elements)
print(f"✅ DOSSIER TOTALE GENERATO SU {len(tutti_turni)} PAGINE CON TUTTI I TURNI (MODIFICATI E NON MODIFICATI)!")
