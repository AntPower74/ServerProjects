#!/usr/bin/env python3
"""
Aggiornamento PDF per Pi0370 e Pi0080:
Pi0370 mantiene tutte le corse mattutine ordinarie (Linee 281 + 703) dalle 06:30 alle 11:45,
effettua la pausa pranzo al Deposito di Pinerolo (11:45 - 12:45),
e RICEVE DA Pi0080 il blocco pomeridiano di Linea 901 (12:50 - 14:55).
In questo modo:
- Si vede esattamente dove si innesta la corsa ricevuta nel pomeriggio (dopo la pausa pranzo)
- L'OLG di Pi0370 sale da 5h15m a 7h20m pieno!
- Il Nastro di Pi0370 è compatto a 8h35m (06:30 - 15:05).
"""
...
# =============================================================
# 1. Pi0080 -> CEDE BLOCCO 901 (12:50 - 14:55) A Pi0370
# =============================================================
t80 = pinerolo['Pi0080']
att_80 = []
for a in t80['attivita']:
    ad = dict(a)
    p = a.get('partenza', '')
    if p in ['12:40', '12:50', '13:35', '14:20']:
        ad['scambio_tag'] = '🔴 CORSA CEDUTA AL TURNO Pi0370 (Linea 901 Torre Pellice A/R)'
    att_80.append(ad)

aggiungi_scheda(t80, att_80, {
    'nuova_dicitura': '8 PINEROLO [SPEZZATO COMPATTO LINEE 278 / 901]',
    'stato': 'SPEZZATO COMPATTO',
    'descrizione': '• <b>Cede a Pi0370:</b> Blocco 12:40–14:55 (Linea 901 Pinerolo ➔ Torre Pellice A/R).<br/>'
                   '• <b>Nuova Organizzazione:</b> Mantiene il mattino 07:00–08:15 (Linea 278) e il tardo pomeriggio 15:35–19:30 (Linee 901+278), riducendo il carico e bilanciando Pi0370.'
}, {
    'orario_prima': '07:00 – 19:30', 'orario_dopo': '07:00 – 19:30',
    'nastro_prima': '12h 30m', 'nastro_dopo': '12h 30m', 'diff_nastro': 'Spezzato',
    'olg_prima': '7h 34m', 'olg_dopo': '5h 30m', 'diff_olg': '−2h 04m (Cedute a Pi0370)',
    'rip_prima': '3 riprese', 'rip_dopo': '2 riprese'
})

# =============================================================
# 2. Pi0370 -> MANTIENE TUTTO IL MATTINO E RICEVE 901 DA Pi0080
# =============================================================
t370 = pinerolo['Pi0370']
att_370 = []
for a in t370['attivita'][:-1]: # tutte le 12 attività mattutine fino alle 11:35
    att_370.append(dict(a))

# Inseriamo la pausa pranzo e il blocco 901 ricevuto da Pi0080
att_370.append({
    'linea': 'Sosta',
    'da': 'Pausa Pranzo / Sosta al Deposito di Pinerolo',
    'descrizione': 'Pausa Pranzo e Ristoro (Pinerolo Deposito)',
    'partenza': '11:35',
    'arrivo': '12:40',
    'km': '-',
...
att_370.append({
    'linea': 'Trasf',
    'da': 'Pinerolo Deposito ➔ PINEROLO - movicentro',
    'descrizione': 'Pinerolo Deposito ➔ PINEROLO movicentro',
    'partenza': '12:40',
    'arrivo': '12:45',
    'km': '2.46',
    'scambio_tag': 'Attività Ordinaria Invariata'
})
att_370.append({
    'linea': '901',
    'da': 'PINEROLO ➔ TORRE PELLICE',
    'descrizione': 'Linea 901: PINEROLO (movicentro) ➔ TORRE PELLICE [RICEVUTA DA TURNO Pi0080]',
    'partenza': '12:50',
    'arrivo': '13:25',
    'km': '17.62',
    'scambio_tag': '🟢 CORSA RICEVUTA DA TURNO Pi0080'
})
att_370.append({
    'linea': '901',
    'da': 'TORRE PELLICE ➔ PINEROLO',
    'descrizione': 'Linea 901: TORRE PELLICE ➔ PINEROLO (movicentro) [RICEVUTA DA TURNO Pi0080]',
    'partenza': '13:35',
    'arrivo': '14:10',
    'km': '18.17',
    'scambio_tag': '🟢 CORSA RICEVUTA DA TURNO Pi0080'
...
att_370.append({
    'linea': 'Trasf',
    'da': 'TORRE PELLICE ➔ Pinerolo Deposito',
    'descrizione': 'TORRE PELLICE ➔ Pinerolo Deposito',
    'partenza': '14:55',
    'arrivo': '15:20',
    'km': '16.85',
    'scambio_tag': 'Attività Ordinaria Invariata'
...
att_370.append({
    ...
    'descrizione': 'Pulizia Interna Autobus e Chiusura Turno (Pinerolo Deposito)',
    'partenza': '15:20',
    'arrivo': '15:30',
    'km': '-',
    'scambio_tag': 'Attività Ordinaria Invariata'
...
aggiungi_scheda(t370, att_370, {
    'nuova_dicitura': '37 PINEROLO [SPEZZATO COMPATTO POTENZIATO LINEE 281 / 703 / 901]',
    'stato': 'POTENZIATO (Da 5h15 a 7h20 OLG)',
    'descrizione': '• <b>Mantiene:</b> Tutte le corse mattutine ordinarie (Linee 281 Scalenghe + 703 Navette) 06:30–11:35.<br/>'
                   '• <b>Riceve da Pi0080:</b> Blocco pomeridiano Linea 901 (12:50–14:55).<br/>'
                   '• <b>Nuova Organizzazione:</b> Mattino + 1h05m di pausa pranzo al Deposito + Pomeriggio 901 fino alle 15:30. Nastro: 9h00, OLG: 7h20 pieno!'
}, {
    'orario_prima': '06:30 – 11:45', 'orario_dopo': '06:30 – 15:30',
    'nastro_prima': '5h 15m', 'nastro_dopo': '9h 00m', 'diff_nastro': '+3h 45m (Compatto)',
    'olg_prima': '5h 15m', 'olg_dopo': '7h 20m', 'diff_olg': '+2h 05m OLG',
    'rip_prima': '1 ripresa', 'rip_dopo': '2 riprese con pausa pranzo'
})
...
for a in t130['attivita']:
    ...
    if a.get('partenza') in ['16:00', '16:40', '17:10', '17:40', '18:20', '18:50', '18:55']:
        ad['scambio_tag'] = '🔴 CORSA CEDUTA AL TURNO Pi0190 (Navette Linea 703)'
    att_130.append(ad)
...
for a in t210['attivita']:
    ...
    if a.get('partenza') in ['06:55', '07:05', '07:35', '08:15', '13:20', '13:30', '14:05']:
        ad['scambio_tag'] = '🔴 CORSA CEDUTA AL TURNO Pi0470 (Blocco Pancalieri)'
    att_210.append(ad)
...
# =============================================================
# 7. Pi0580 -> CEDE CORSA 13:05 A Pi0290
# =============================================================
...
for a in t580['attivita']:
    ...
    if a.get('partenza') in ['06:40', '06:50', '07:00', '07:20', '07:25', '08:10', '13:04', '13:05', '13:35']:
        ad['scambio_tag'] = '🔴 CORSA CEDUTA AL TURNO Pi0290 (Corsa Linea 275)'
    att_580.append(ad)
...
# =============================================================
# 8. Pi0290 -> RICEVE CORSA 13:05 DA Pi0580
# =============================================================
...
# =============================================================
# 9. Pi0560 -> CEDE MATTINO A Pi0280
# =============================================================
...
for a in t560['attivita']:
    ...
    if a.get('partenza') in ['05:30', '05:40', '06:05', '06:36', '08:11', '09:20']:
        ad['scambio_tag'] = '🔴 CORSA CEDUTA AL TURNO Pi0280 (Torino Bolzano A/R)'
    att_560.append(ad)
...
# =============================================================
# 10. Pi0280 -> RICEVE TORINO BOLZANO DA Pi0560
# =============================================================
...
# =============================================================
# 11. Pi0260 -> CEDE BLOCCO POMERIDIANO A Pi0020
# =============================================================
...
for a in t260['attivita']:
    ...
    if a.get('partenza') in ['13:05', '13:25', '14:08', '14:30', '15:15']:
        ad['scambio_tag'] = '🔴 CORSA CEDUTA AL TURNO Pi0020 (Tratta 278/284 Airasca/Vandalino)'
    att_260.append(ad)
...
# =============================================================
# 12. Pi0020 -> RICEVE BLOCCO POMERIDIANO DA Pi0260
# =============================================================
...
doc.build(elements)
print(f"✅ PDF AGGIORNATO CON INSERIMENTO PUNTUALE DI DOVE VANNO LE CORSE:\n{PDF_OUT}")
