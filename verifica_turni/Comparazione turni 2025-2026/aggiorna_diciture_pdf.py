#!/usr/bin/env python3
"""
Aggiornamento del PDF con Diciture Complete e Scambiate:
- Intestazioni di ciascuna scheda con la nuova qualifica operativa del turno
- Diciture dettagliate delle tratte, origini, destinazioni e linee per ogni corsa scambiata
- Note di scambio chiare ed esplicite
"""
...
def aggiungi_scheda(t_orig, att_list, scambi_info, params_box):
    ...
    corse_data = [[
        ...
        Paragraph("Dicitura & Stato Operativo dello Scambio", th_style)
    ]]
...
# =============================================================
# DEFINIZIONE SCHEDE CON NUOVE DICITURE
# =============================================================
...
for a in t80['attivita']:
    ...
    if a.get('partenza') in ['07:00', '07:10', '07:15', '07:35', '07:40', '08:05']:
        ad['scambio_tag'] = 'CORSA CEDUTA AL TURNO Pi0370 (Mattino spostato a Pi0370)'
    att_80.append(ad)
...
att_370 = [
    ...
    {'linea': '278', 'da': 'PINEROLO ➔ CERCENASCO - Via Umberto I', 'descrizione': 'Linea 278: PINEROLO ➔ CERCENASCO (Via Umberto I)', 'partenza': '07:15', 'arrivo': '07:35', 'km': '14.86', 'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0080 (Linea 278)'},
    {'linea': '278', 'da': 'VIGONE ➔ PINEROLO - Piazza Cavour', 'descrizione': 'Linea 278: VIGONE (Via Torino) ➔ PINEROLO (Piazza Cavour)', 'partenza': '07:40', 'arrivo': '08:05', 'km': '16.32', 'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0080 (Linea 278)'},
...
for a in t130['attivita']:
    ...
    if a.get('partenza') in ['16:00', '16:40', '17:10', '17:40', '18:20', '18:50', '18:55']:
        ad['scambio_tag'] = 'CORSA CEDUTA AL TURNO Pi0190 (Chiusura anticipata alle 15:35)'
    att_130.append(ad)
...
att_190 = [
    ...
    {'linea': '703', 'da': 'PINEROLO Fiugera ➔ RIVA / PASCARETTO', 'descrizione': 'Linea 703: PINEROLO Fiugera ➔ RIVA DI PINEROLO (5 Navette)', 'partenza': '16:00', 'arrivo': '18:50', 'km': '59.47', 'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0130 (Anticipa inizio alle 16:00)'},
...
for a in t210['attivita']:
    ...
    if a.get('partenza') in ['06:55', '07:05', '07:35', '08:15', '13:20', '13:30', '14:05']:
        ad['scambio_tag'] = 'CORSA CEDUTA AL TURNO Pi0470 (Inizio spostato al pomeriggio)'
    att_210.append(ad)
...
att_470.append({'linea': '278', 'da': 'PINEROLO - Stazione FS ➔ PANCALIERI', 'descrizione': 'Linea 278: PINEROLO (Stazione FS) ➔ PANCALIERI (Scuole Medie)', 'partenza': '13:30', 'arrivo': '14:05', 'km': '23.70', 'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0210 (Linea 278)'})
att_470.append({'linea': '281', 'da': 'PANCALIERI ➔ PINEROLO - Fronte Stazione FS', 'descrizione': 'Linea 281: PANCALIERI ➔ PINEROLO (Fronte Stazione FS)', 'partenza': '14:05', 'arrivo': '14:55', 'km': '32.48', 'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0210 (Linea 281)'})
...
for a in t580['attivita']:
    ...
    if a.get('partenza') in ['06:40', '06:50', '07:00', '07:20', '07:25', '08:10', '13:04', '13:05', '13:35']:
        ad['scambio_tag'] = 'CORSA CEDUTA AL TURNO Pi0290 (Mattino e corsa 13:05 ceduti a Pi0290)'
    att_580.append(ad)
...
att_290.insert(10, {
    ...
    'descrizione': 'Linea 275: PINEROLO (Bivio SAPAV) ➔ Villar Perosa (Stabilimento SKF)',
    'partenza': '13:05',
    'arrivo': '13:35',
    'km': '13.56',
    'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0580 (Linea 275)'
})
...
for a in t560['attivita']:
    ...
    if a.get('partenza') in ['05:30', '05:40', '06:05', '06:36', '08:11', '09:20']:
        ad['scambio_tag'] = 'CORSA MATTUTINA CEDUTA AL TURNO Pi0280 (Inizio al pomeriggio)'
    att_560.append(ad)
...
att_280 = [
    ...
    {'linea': 'Trasf', 'da': 'Pinerolo Deposito ➔ TORRE PELLICE', 'descrizione': 'Pinerolo Deposito ➔ TORRE PELLICE', 'partenza': '05:40', 'arrivo': '06:05', 'km': '16.85', 'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0560 (Linea 901)'},
    {'linea': '901', 'da': 'TORRE PELLICE ➔ PINEROLO - movicentro', 'descrizione': 'Linea 901: TORRE PELLICE ➔ PINEROLO (movicentro)', 'partenza': '06:05', 'arrivo': '06:35', 'km': '18.17', 'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0560 (Linea 901)'},
    {'linea': '282', 'da': 'PINEROLO ➔ TORINO - Autostazione c.so Bolzano', 'descrizione': 'Linea 282: PINEROLO (movicentro) ➔ TORINO (Autostazione c.so Bolzano)', 'partenza': '06:36', 'arrivo': '07:47', 'km': '44.60', 'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0560 (Linea 282)'},
    {'linea': '275', 'da': 'TORINO ➔ PINEROLO - Piazza Cavour', 'descrizione': 'Linea 275: TORINO (Autostazione) ➔ PINEROLO (Piazza Cavour)', 'partenza': '08:11', 'arrivo': '09:20', 'km': '42.11', 'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0560 (Linea 275)'},
...
for a in t260['attivita']:
    ...
    if a.get('partenza') in ['13:05', '13:25', '14:08', '14:30', '15:15']:
        ad['scambio_tag'] = 'CORSA CEDUTA AL TURNO Pi0020 (Eliminazione ripresa pomeridiana)'
    att_260.append(ad)
...
att_020.append({'linea': '278', 'da': 'PINEROLO ➔ SCA - FR Pieve Via Savigliani', 'descrizione': 'Linea 278: PINEROLO ➔ SCALENGHE (Frazione Pieve)', 'partenza': '13:25', 'arrivo': '14:08', 'km': '26.13', 'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0260 (Linea 278)'})
att_020.append({'linea': '284', 'da': 'AIRASCA SKF ➔ SEGGIOVIA VANDALINO', 'descrizione': 'Linea 284: AIRASCA (SKF) ➔ TORRE PELLICE (Seggovia Vandalino)', 'partenza': '14:30', 'arrivo': '15:15', 'km': '33.21', 'scambio_tag': 'CORSA RICEVUTA DAL TURNO Pi0260 (Linea 284)'})
...
doc.build(elements)
print(f"✅ PDF AGGIORNATO CON TUTTE LE NUOVE DICITURE:\n{PDF_OUT}")
