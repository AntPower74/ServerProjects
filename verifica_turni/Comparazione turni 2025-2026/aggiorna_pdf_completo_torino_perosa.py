#!/usr/bin/env python3
"""
Rigenerazione PDF Ufficiale con 14 Schede Complete:
- 12 Schede Pinerolo + Perosa (Pi0080, Pi0370, Pi0130, Pi0190, Pi0210, Pi0470, Pi0580, Pi0560, Pi0280, Pi0260, Pe0270, Pi0620)
- 2 Nuove Schede Scambio Torino <-> Pinerolo: To0710 (710 DI TORINO) e Pi0300 (30 PINEROLO)
"""
...
def aggiungi_scheda_turno_pulita(t_orig, att_list, scambi_info, params_box):
    ...
    sub_text = f"Progetto: <b>Ottimizzazione Turni e Scambi di Bacino 2026</b> | Validità: <b>Lunedì - Venerdì Scolastico</b>"
...
# =============================================================
# 13. To0710 (710 DI TORINO - Deposito di TORINO)
# =============================================================
t_to710 = turni_dict['To0710']
att_to710 = [
    {'linea': 'Disp', 'da': 'Controllo livelli autobus', 'descrizione': 'Controllo livelli autobus (Torino Deposito)', 'partenza': '07:45', 'arrivo': '07:55', 'km': '-', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Trasf', 'da': 'TORINO DEPOSITO ➔ Torino Corso Bolzano', 'descrizione': 'TORINO DEPOSITO ➔ Torino Corso Bolzano', 'partenza': '07:55', 'arrivo': '08:15', 'km': '3.50', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '277', 'da': 'TORINO ➔ AIRASCA SKF', 'descrizione': 'Linea 277: TORINO (Autostazione Bolzano) ➔ AIRASCA SKF', 'partenza': '08:20', 'arrivo': '09:20', 'km': '33.20', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '277', 'da': 'AIRASCA SKF ➔ TORINO', 'descrizione': 'Linea 277: AIRASCA SKF ➔ TORINO (Autostazione)', 'partenza': '09:30', 'arrivo': '10:20', 'km': '33.20', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '119', 'da': 'TO ➔ Corso Vercelli-Via Cuorgnè', 'descrizione': 'Linea 119: TO (Autostazione) ➔ Corso Vercelli [RICEVUTA DA Pi0300]', 'partenza': '12:15', 'arrivo': '12:37', 'km': '11.00', 'scambio_tag': '🟢 CORSA RICEVUTA DA TURNO Pi0300'},
    {'linea': '277', 'da': 'TO ➔ Corso Belgio ➔ AIRASCA', 'descrizione': 'Linea 277: TO (Corso Belgio) ➔ AIRASCA SKF [RICEVUTA DA Pi0300]', 'partenza': '12:37', 'arrivo': '13:55', 'km': '38.45', 'scambio_tag': '🟢 CORSA RICEVUTA DA TURNO Pi0300'},
    {'linea': '277', 'da': 'AIRASCA SKF ➔ TORINO', 'descrizione': 'Linea 277: AIRASCA (SKF) ➔ TORINO (c.so Francia/via Pasteur)', 'partenza': '14:30', 'arrivo': '15:24', 'km': '33.20', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '119', 'da': 'TO ➔ Collegno Corso Francia', 'descrizione': 'Linea 119: TO ➔ Collegno Corso Francia', 'partenza': '15:24', 'arrivo': '15:40', 'km': '6.50', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Trasf', 'da': 'Collegno ➔ TORINO DEPOSITO', 'descrizione': 'Collegno ➔ TORINO DEPOSITO', 'partenza': '15:40', 'arrivo': '15:55', 'km': '4.50', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Disp', 'da': 'Pulizia Interna Autobus', 'descrizione': 'Pulizia Interna Autobus e Chiusura Turno (Torino Deposito)', 'partenza': '15:55', 'arrivo': '16:05', 'km': '-', 'scambio_tag': 'Attività Ordinaria Invariata'}
]

aggiungi_scheda_turno_pulita(t_to710, att_to710, {
    'deposito': 'Torino',
    'nuova_dicitura': '710 DI TORINO [MATTINALE / POMERIDIANO CONTINUO LINEE 277 / 119]',
    'stato': 'CONTINUO COMPATTO (Nastro -3h00)',
    'descrizione': '• <b>Corse Ricevute da Pi0300:</b> Anello centrale 12:15–13:55 (Linee 119+277 Torino ➔ Airasca).<br/>'
                   '• <b>Nuovo Servizio Effettivo:</b> Elimina la discesa isolata a vuoto a Pinerolo all’alba e le 3h16m di buco al deposito di Torino. Nastro abbattuto da 11h20 a 8h20 in ripresa continua!'
}, {
    'orario_prima': '04:45 – 16:05', 'orario_dopo': '07:45 – 16:05',
    'nastro_prima': '11h 20m', 'nastro_dopo': '8h 20m', 'diff_nastro': '−3h 00m',
    'olg_prima': '7h 24m', 'olg_dopo': '7h 25m', 'diff_olg': 'Continuo',
    'rip_prima': '2 riprese (sosta 3h16)', 'rip_dopo': '1 ripresa continua'
})

# =============================================================
# 14. Pi0300 (30 PINEROLO - Deposito di PINEROLO)
# =============================================================
t_pi300 = turni_dict['Pi0300']
att_pi300 = [
    {'linea': 'Disp', 'da': 'Controllo livelli autobus', 'descrizione': 'Controllo livelli autobus (Pinerolo Deposito)', 'partenza': '06:00', 'arrivo': '06:10', 'km': '-', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Trasf', 'da': 'Pinerolo Deposito ➔ PINEROLO', 'descrizione': 'Pinerolo Deposito ➔ PINEROLO Stazione FS', 'partenza': '06:10', 'arrivo': '06:20', 'km': '2.46', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '281', 'da': 'PINEROLO ➔ GERBOLE DI VOLVERA', 'descrizione': 'Linea 281: PINEROLO ➔ GERBOLE DI VOLVERA', 'partenza': '06:20', 'arrivo': '06:50', 'km': '18.07', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '281', 'da': 'GERBOLE DI VOLVERA ➔ PINEROLO', 'descrizione': 'Linea 281: GERBOLE DI VOLVERA ➔ PINEROLO (Stazione FS)', 'partenza': '06:55', 'arrivo': '07:35', 'km': '18.07', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '281', 'da': 'PINEROLO ➔ Ist. Immacolata', 'descrizione': 'Linea 281: PINEROLO ➔ Ist. Immacolata', 'partenza': '07:35', 'arrivo': '07:50', 'km': '6.50', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '281', 'da': 'PONTE SAN MARTINO ➔ Pinerolo Centro Studi', 'descrizione': 'Linea 281: PONTE SAN MARTINO ➔ Pinerolo Centro Studi', 'partenza': '07:55', 'arrivo': '08:10', 'km': '7.20', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Trasf', 'da': 'Pinerolo Centro Studi ➔ Pinerolo Deposito', 'descrizione': 'Pinerolo Centro Studi ➔ Pinerolo Deposito', 'partenza': '08:10', 'arrivo': '08:15', 'km': '1.40', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Sosta', 'da': 'Pausa Pranzo / Sosta a Pinerolo Deposito', 'descrizione': 'Pausa Pranzo e Ristoro (Pinerolo Deposito)', 'partenza': '08:15', 'arrivo': '12:45', 'km': '-', 'scambio_tag': 'Pausa Ristoro Regolare'},
    {'linea': 'Trasf', 'da': 'Pinerolo Deposito ➔ PINEROLO Stazione FS', 'descrizione': 'Pinerolo Deposito ➔ PINEROLO Stazione FS', 'partenza': '12:45', 'arrivo': '13:00', 'km': '2.46', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '278', 'da': 'PINEROLO ➔ VIRLE PIEMONTE', 'descrizione': 'Linea 278: PINEROLO ➔ VIRLE PIEMONTE', 'partenza': '13:05', 'arrivo': '13:55', 'km': '25.80', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '281', 'da': 'VIRLE PIEMONTE ➔ PINEROLO', 'descrizione': 'Linea 281: VIRLE PIEMONTE ➔ PINEROLO (Piazza Cavour)', 'partenza': '14:00', 'arrivo': '14:40', 'km': '25.80', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Trasf', 'da': 'PINEROLO ➔ Pinerolo Deposito', 'descrizione': 'PINEROLO Piazza Cavour ➔ Pinerolo Deposito', 'partenza': '14:40', 'arrivo': '14:45', 'km': '2.40', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Disp', 'da': 'Pulizia Interna Autobus', 'descrizione': 'Pulizia Interna Autobus e Chiusura Turno (Pinerolo Deposito)', 'partenza': '14:45', 'arrivo': '14:55', 'km': '-', 'scambio_tag': 'Attività Ordinaria Invariata'}
]

aggiungi_scheda_turno_pulita(t_pi300, att_pi300, {
    'deposito': 'Pinerolo',
    'nuova_dicitura': '30 PINEROLO [SPEZZATO COMPATTO LINEE 281 / 278]',
    'stato': 'SPEZZATO COMPATTO (Nastro -2h35)',
    'descrizione': '• <b>Corse Cedute a To0710:</b> Tratta centrale su Torino 10:23–13:55 (Linee 275+119+277).<br/>'
                   '• <b>Nuovo Servizio Effettivo:</b> Si concentra sul bacino di Pinerolo, Gerbole e Virle, chiudendo il servizio alle 14:55 al Deposito di Pinerolo. Nastro abbattuto da 11h30 a 8h55!'
}, {
    'orario_prima': '06:00 – 17:30', 'orario_dopo': '06:00 – 14:55',
    'nastro_prima': '11h 30m', 'nastro_dopo': '8h 55m', 'diff_nastro': '−2h 35m',
    'olg_prima': '7h 16m', 'olg_dopo': '5h 45m', 'diff_olg': 'Compatto',
    'rip_prima': '3 riprese', 'rip_dopo': '2 riprese con pausa pranzo'
})

doc.build(elements)
print(f"✅ PDF GENERATO CON 14 SCHEDE COMPLETE:\n{PDF_OUT}")
