#!/usr/bin/env python3
"""
Generazione PDF con Struttura Finale Reale dei Turni:
- Nel turno cedente (es. Pi0080): le corse cedute NON ci sono più nella tabella, la tabella mostra SOLO il nuovo servizio effettivo (12:40 - 19:30)!
- Nel turno ricevente (es. Pi0370): la tabella mostra il servizio con le corse ricevute evidenziate in VERDE con la dicitura '[CORSA RICEVUTA DA Pi0080]'.
- Questo principio viene applicato coerentemente a TUTTI i turni.
"""
...
# =============================================================
# 1. Pi0080: SENZA LE CORSE CEDUTE (Servizio effettivo 12:40 - 19:30)
# =============================================================
t80 = pinerolo['Pi0080']
att_80 = [
...
aggiungi_scheda_turno_pulita(t80, att_80, {
    ...
    'descrizione': '• <b>Corse Cedute a Pi0370:</b> Corsa mattutina 07:00–08:15 (Linea 278 Pinerolo ➔ Cercenasco ➔ Vigone).<br/>'
                   '• <b>Nuovo Servizio Effettivo:</b> Inizia alle 12:40 ed effettua servizio continuo (Linee 901+278) fino alle 19:30. Nastro abbattuto da 12h30 a 6h50, <b>zero buchi passivi e zero stacchi!</b>'
}, {
...
# =============================================================
# 2. Pi0370: CON LE CORSE RICEVUTE DA Pi0080
# =============================================================
...
# =============================================================
# 3. Pi0130: SENZA LE CORSE CEDUTE (Servizio effettivo 06:35 - 15:35)
# =============================================================
...
# =============================================================
# 4. Pi0190: CON LE CORSE RICEVUTE DA Pi0130
# =============================================================
...
# =============================================================
# 5. Pi0210: SENZA LE CORSE CEDUTE (Servizio effettivo 14:55 - 19:25)
# =============================================================
...
# =============================================================
# 6. Pi0470: CON LE CORSE RICEVUTE DA Pi0210
# =============================================================
...
# =============================================================
# 7. Pi0580: SENZA LE CORSE CEDUTE (Servizio effettivo 13:40 - 19:10)
# =============================================================
t580 = pinerolo['Pi0580']
att_580 = [
    {'linea': 'Disp', 'da': 'Controllo livelli autobus', 'descrizione': 'Controllo livelli autobus (Pinerolo Deposito)', 'partenza': '13:40', 'arrivo': '13:50', 'km': '-', 'scambio_tag': 'Attività Ordinaria Invariata'},
...
aggiungi_scheda_turno_pulita(t580, att_580, {
    ...
    'stato': 'POMERIDIANO CONTINUO (ZERO STACCHI)',
    'descrizione': '• <b>Corse Cedute a Pi0290:</b> Corsa 13:05 (Linea 275 Villar Perosa SKF).<br/>'
                   '• <b>Nuovo Servizio Effettivo:</b> Inizia alle 13:40 ed effettua servizio continuo (Linee 901+281+284) fino alle 19:10. Nastro da 12h30 a 5h30.'
}, {
...
# =============================================================
# 8. Pi0290: CON LA CORSA RICEVUTA DA Pi0580
# =============================================================
...
aggiungi_scheda_turno_pulita(t290, att_290, {
    ...
    'descrizione': '• <b>Corse Ricevute da Pi0580:</b> Corsa 13:05 (Linea 275 Villar Perosa SKF).<br/>'
                   '• <b>Nuovo Servizio Effettivo:</b> Si aggancia al rientro da Torino Bolzano aumentando l’OLG a 6h45m senza variare il nastro (05:33–14:20).'
}, {
...
# =============================================================
# 9. Pi0560: SENZA LE CORSE CEDUTE (Servizio effettivo 13:20 - 17:38)
# =============================================================
...
# =============================================================
# 10. Pi0280: CON LE CORSE RICEVUTE DA Pi0560
# =============================================================
...
# =============================================================
# 11. Pi0260: SENZA LE CORSE CEDUTE (Servizio effettivo compatto)
# =============================================================
...
att_260 = [
    ...
    {'linea': '275', 'da': 'PINEROLO ➔ PEROSA ARGENTINA', 'descrizione': 'Linea 275: PINEROLO ➔ PEROSA ARGENTINA', 'partenza': '07:05', 'arrivo': '07:35', 'km': '18.42', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '281', 'da': 'PEROSA ARGENTINA ➔ VILLARETTO', 'descrizione': 'Linea 281: PEROSA ARGENTINA ➔ VILLARETTO A/R', 'partenza': '07:35', 'arrivo': '08:15', 'km': '15.20', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Trasf', 'da': 'PEROSA ARGENTINA ➔ Pinerolo Deposito', 'descrizione': 'PEROSA ARGENTINA ➔ Pinerolo Deposito', 'partenza': '08:15', 'arrivo': '08:45', 'km': '18.42', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Sosta', 'da': 'Pausa Pranzo / Sosta a Pinerolo Deposito', 'descrizione': 'Pausa Pranzo e Ristoro (Pinerolo Deposito)', 'partenza': '08:45', 'arrivo': '15:20', 'km': '-', 'scambio_tag': 'Pausa Ristoro Regolare'},
    {'linea': '284', 'da': 'PINEROLO ➔ SEGGIOVIA VANDALINO', 'descrizione': 'Linea 284: PINEROLO ➔ SEGGIOVIA VANDALINO', 'partenza': '15:20', 'arrivo': '16:05', 'km': '24.10', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': '275', 'da': 'TORRE PELLICE ➔ PINEROLO', 'descrizione': 'Linea 275: TORRE PELLICE ➔ PINEROLO (movicentro)', 'partenza': '16:15', 'arrivo': '17:15', 'km': '22.30', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Trasf', 'da': 'PINEROLO ➔ Pinerolo Deposito', 'descrizione': 'PINEROLO movicentro ➔ Pinerolo Deposito', 'partenza': '17:15', 'arrivo': '17:25', 'km': '2.40', 'scambio_tag': 'Attività Ordinaria Invariata'},
    {'linea': 'Disp', 'da': 'Pulizia Interna Autobus', 'descrizione': 'Pulizia Interna Autobus e Chiusura Turno (Pinerolo Deposito)', 'partenza': '17:25', 'arrivo': '17:35', 'km': '-', 'scambio_tag': 'Attività Ordinaria Invariata'}
]
...
aggiungi_scheda_turno_pulita(t260, att_260, {
    ...
    'descrizione': '• <b>Corse Cedute a Pi0020:</b> Tratta pomeridiana 13:05–15:20 (Linee 278+284 Airasca/Vandalino).<br/>'
                   '• <b>Nuovo Servizio Effettivo:</b> Elimina la ripresa intermedia e chiude alle 17:35 con nastro abbattuto a 8h30.'
}, {
    'orario_prima': '06:49 – 18:51', 'orario_dopo': '06:49 – 17:35',
...
# =============================================================
# 12. Pi0020: CON LE CORSE RICEVUTE DA Pi0260
# =============================================================
...
aggiungi_scheda_turno_pulita(t020, att_020, {
    ...
    'descrizione': '• <b>Corse Ricevute da Pi0260:</b> Tratta 13:25–15:15 (Linee 278+284 Airasca/Vandalino).<br/>'
                   '• <b>Nuovo Servizio Effettivo:</b> Elimina le navette frammentate di Macello e fa 2 blocchi continui con 6h50m di OLG pieno.'
}, {
...
doc.build(elements)
print(f"✅ PDF GENERATO CON TABELLE FINALI PULITE:\n{PDF_OUT}")
