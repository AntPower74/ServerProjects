#!/usr/bin/env python3
"""
Correzione Definitiva Pi0080 e Pi0370 per eliminare ogni stacco:
- Pi0080 CEDE il mattino (07:00 - 08:15) e fa il blocco pomeridiano/serale CONTINUO (12:40 - 19:30): ZERO STACCHI!
  Nastro: 6h 50m | OLG: 6h 25m | 1 Ripresa Continua.
- Pi0370 RICEVE il mattino (07:00 - 08:15 Linea 278) e prosegue con Linea 703 (08:20 - 11:45): ZERO STACCHI!
  Nastro: 4h 45m | OLG: 4h 45m | 1 Ripresa Continua.
"""
    ...
    box_data = [
        [
            Paragraph(f"🔴 <b>CARTELLINO ATTUALE AZIENDA:</b><br/>"
                      ...
                      f"• Riprese: <b>{params_box['rip_prima']}</b> (con buco non pagato di oltre 4 ore)", box_body),
            Paragraph(f"🟢 <b>NUOVA STRUTTURA DOPO LO SCAMBIO:</b><br/>"
                      ...
                      f"• Riprese: <b>{params_box['rip_dopo']} (ZERO STACCHI)</b>", box_body),
...
# =============================================================
# 1. Pi0080 -> CEDE MATTINO A Pi0370 E DIVENTA POMERIDIANO CONTINUO
# =============================================================
t80 = pinerolo['Pi0080']
att_80 = []
for a in t80['attivita']:
    ...
    if p in ['07:00', '07:10', '07:15', '07:35', '07:40', '08:05']:
        ad['scambio_tag'] = '🔴 CORSA CEDUTA AL TURNO Pi0370 (Elimina sveglia presto e buco passivo)'
    att_80.append(ad)
...
aggiungi_scheda(t80, att_80, {
    ...
    'descrizione': '• <b>Cede a Pi0370:</b> Mattino 07:00–08:15 (Linea 278 Pinerolo ➔ Cercenasco ➔ Vigone).<br/>'
                   '• <b>Nuova Organizzazione:</b> Inizia alle 12:40 ed effettua servizio continuativo pomeridiano/serale (Linee 901+278) fino alle 19:30. Nastro da 12h30 a 6h50, <b>zero stacchi intermedi!</b>'
}, {
...
# =============================================================
# 2. Pi0370 -> RICEVE MATTINO DA Pi0080 (MATTINALE CONTINUO)
# =============================================================
...
aggiungi_scheda(t370, att_370, {
    ...
    'descrizione': '• <b>Riceve da Pi0080:</b> Tratta 07:15–08:05 (Linea 278 Pinerolo ➔ Cercenasco ➔ Vigone).<br/>'
                   '• <b>Nuova Organizzazione:</b> Sequenza continua 07:00–11:45 (Linea 278 + Navette 703). Nessun conflitto orario, nastro compatto a 4h45, <b>zero stacchi intermedi!</b>'
}, {
...
doc.build(elements)
print(f"✅ PDF CORRETTO SENZA ALCUNO STACCO INTERMEDIO:\n{PDF_OUT}")
