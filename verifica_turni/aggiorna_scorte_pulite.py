...
from CONDIZIONI_E_REGOLE_TURNI import TURNI_SPECIALI_40H, MAPPA_CAMBI_TURNO
...
for idx, t in enumerate(tutti_turni):
    ...
    if is_scorta:
        ...
        box_diff_text = f"• <b>&Delta; Nastro:</b> 0h 00m (Confermato {p_nastro}) | " \
                        ...
                        f"• <b>RUOLO OPERATIVO:</b> Presidio rimessa a {dep} per copertura emergenze, guasti, sostituzioni e uscite vetture."
    elif code == "To0280":
        corse_prop_tutte = [
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO AGGIORNATO: Turni di Scorta ripuliti con visualizzazione perfetta e senza righe duplicate!")
