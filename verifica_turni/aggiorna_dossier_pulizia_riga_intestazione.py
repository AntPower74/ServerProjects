    ...
    if m_nastro and m_olg:
        ...
        for i, l in enumerate(lines):
            if re.match(r'^\d{1,2}\.\d{2}$', l) and i+1 < len(lines) and re.match(r'^\d{1,2}\.\d{2}$', lines[i+1]):
                ...
                # FILTRO CATEGORICO: ESCLUDIAMO LA RIGA SPORCA DELL'INTESTAZIONE "Ora inizio turno :"
...
mappa_cambi_completa = {
    ...
    'To0280': "🔄 <b>CAMBIO CON:</b> Alle 11:45 a piazza Carlo Felice <b>CEDE IL BUS a To0710</b> (che copre la corsa delle 12:00/12:30). Rientro a Grugliasco alle 12:40.",
...
for idx, t in enumerate(tutti_turni):
    ...
    if code == "To0280":
        ...
        corse_prop_puntuali.append(["11:45", "12:00", "CAMBIO", "<b>CAMBIO A CARLO FELICE -> CEDE IL BUS A To0710</b>"])
        ...
        box_diff_text = f"• <b>&Delta; Nastro:</b> 0h 00m (Confermato compatto a {p_nastro}) | " \
                        ...
                        f"• <b>NOTA CAMBIO TURNO:</b> Alle 11:45 a piazza Carlo Felice <b>cede il bus al turno montante To0710</b>. Rientro a Grugliasco e smonto alle 12:40."
    ...
    # SINISTRA (Azienda SENZA la riga sporca dell'intestazione)
    rows_orig = [
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO PULITO AL 100%: Eliminata la riga spuria 'Ora inizio turno :' su tutti i 156 cartellini!")
