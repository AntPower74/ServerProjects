...
# PDF 1: I 17 TURNI CON PROPOSTA ATTIVA DI CAMBIO SUL POSTO (TORINO)
pdf_migl_out = "/home/antonio/verifica_turni/Comparazione turni 2025-2026/Dossier_TURNI_MIGLIORATI_2026.pdf"

# PDF 2: TUTTI GLI ALTRI 136 TURNI (DATI AZIENDALI CONFERMATI)
pdf_conf_out = "/home/antonio/verifica_turni/Comparazione turni 2025-2026/Dossier_TURNI_CONFERMATI_2026.pdf"

# I soli 17 turni dove c'è una reale proposta di modifica organizzativa
cambi_attivi = {
    'To0270': "Cessione bus a To0310 a Carlo Felice alle 11:00 (Smonto a 7h15 in Auto Aziendale)",
    'To0280': "Cessione bus a To0710 a Carlo Felice alle 11:45 (Smonto alle 12:40 in Auto Aziendale)",
    'To0290': "Cessione bus a To0320 a Carlo Felice alle 12:15 in Auto Aziendale",
    'To0295': "Cessione bus a To0330 a Carlo Felice alle 12:45 in Auto Aziendale",
    'To0300': "Cessione bus a To0330 a Carlo Felice alle 13:15 in Auto Aziendale",
    ...
    'To0360': "Notturno Caselle con corsa passeggeri 00:00 -> 00:45 e rientro in bus (Zero vuoti da Caselle)",
    'To0610': "Cessione bus a Porta Susa a To0650 alle 09:30 in Auto Aziendale",
    'To0620': "Cessione bus a Porta Susa a To0660 alle 09:30 in Auto Aziendale",
    ...
    'To0700': "Cessione bus a To0670 a Porta Susa alle 12:45 in Auto Aziendale",
...
# DIVISIONE RIGOROSA:
turni_migliorati_list = [t for t in tutti_turni if t['turno'] in cambi_attivi]
turni_confermati_list = [t for t in tutti_turni if t['turno'] not in cambi_attivi]
...
def build_pdf(lista_turni, filename, is_migl_pdf):
    ...
    for idx, t in enumerate(lista_turni):
        ...
        # Dati RIGOROSAMENTE REALI E IDENTICI AI CARTELLINI EFFETTIVI
        ...
        if is_migl_pdf:
            ...
            box_diff_text = f"• <b>MIGLIORAMENTO OPERATIVO:</b> {cambi_attivi[code]}<br/>" \
                            f"• <b>Nastro:</b> {p_nastro} | • <b>OLG:</b> {p_olg} | • <b>Riprese:</b> 1 (Continuo)"
        else:
...
print(f"✅ GENERATI I 2 PDF PERFETTI E VERITIERI:\n1. {pdf_migl_out} ({len(turni_migliorati_list)} Pagine: Solo i Cambi Reali di Torino)\n2. {pdf_conf_out} ({len(turni_confermati_list)} Pagine: Tutti gli altri turni con dati reali identici all'azienda)")
