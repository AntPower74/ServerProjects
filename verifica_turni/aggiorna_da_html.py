...
print("Leggo i file HTML dei turni...")
...
print(f"Estratti {len(shifts_data)} turni unici dai file HTML.")
...
print(f"Sto per aggiornare {matched} turni nel foglio Google usando i dati originali del sito web...")
batch_size = 200
for i in range(0, len(updates), batch_size):
    ws.batch_update(updates[i:i+batch_size])

print("Aggiornamento completato con successo! (Precisione al 100%)")
