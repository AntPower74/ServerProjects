...
mappa_cambi_completa = {
    ...
    'Ba3510': "■ <b>CAMBIO CON:</b> Turno spezzato con rientro mattutino a <b>BARGE</b> alle 09:30 con linea 000280 e spezzone serale con rientro alle 23:22 in <b>BUS</b>.",
    'Ba3520': "■ <b>CAMBIO CON:</b> A Pinerolo Centro Studi alle 08:10 sosta regolare e rientro pomeridiano a Barge alle 18:03 in <b>BUS</b>.",
...
for idx, t in enumerate(tutti_turni):
    ...
    # Preleviamo TUTTE le righe originali senza tagliare nulla
    corse_orig_tutte = t['corse_raw']
    corse_prop_tutte = []
    
    # Costruiamo la Proposta mantenendo la completezza assoluta di tutte le tratte e garantendo la chiusura a deposito
    ...
    # SINISTRA (Azienda - DINAMICA: fino a 22 righe complete senza MAI tagliare)
    rows_orig = [
    ...
    # DESTRA (Nostra Proposta - DINAMICA: tutte le righe complete)
    ...
    # BOX CAMBI SEPARATO SOTTO LE TABELLE
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO RIGENERATO: 100% DI TUTTE LE RIGHE E TUTTI I RIENTRI VISIBILI SU TUTTI I 156 TURNI SENZA ALCUN TAGLIO!")
