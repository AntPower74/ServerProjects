...
# Load sheet names for validation
...
def extract_all_crew_2025():
    # Only using weekday school shifts
...
print(f'Extracted {len(shifts_2025)} total matched shifts from 2025 PDF.')
...
print(f"Preparing to update {len(updates)//12} shifts in the Google Sheet...")
batch_size = 200
