...
for idx, t in enumerate(tutti_turni):
    ...
    is_40h = code in ('To0660', 'Pi0140', 'Pi0200') # To0280 confermato compatto a 7h35
    is_lungo = n_val > 10.0
    ...
    if code == "To0280":
        # TO0280: CHIUSURA DIRETTA SENZA ATTESE A CARLO FELICE!
        ...
        corse_prop_puntuali.append(["12:00", "12:30", "Trasf", "TO Carlo Felice -> TORINO RIMESSA (Grugliasco)"])
        corse_prop_puntuali.append(["12:30", "12:40", "Disp", "Pulizia interna Autobus & Fine servizio regolare"])
        p_fine = "12:40"
        p_nastro = "7h 35m"
        p_olg = "7h 35m"
        p_rip = "1"
        p_pasto = "0 (€ 0.00)"
        stato_header = "🔵 TURNO CONFERMATO COMPATTO (NESSUNA ATTESA PASSIVA)"
        box_diff_text = f"• <b>&Delta; Nastro:</b> 0h 00m (Confermato compatto a {p_nastro}) | " \
                        ...
                        f"• <b>STATO OPERATIVO:</b> <b>TURNO GIÀ OTTIMALE E CONTINUO.</b> Copre 3 giri completi di Caselle con pausa a norma di legge e rientro diretto a Grugliasco alle 12:40."
        law_specifica = "• <b>CCNL Autoferrotranvieri & L. 138/1958:</b> Turno pienamente conforme. Nastro compatto (7h35), guida &le; 5h00, pausa regolare e rientro in sede."
    else:
        if vere_corse_linea:
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO AGGIORNATO: To0280 rientra regolarmente a Grugliasco senza attese fittizie!")
