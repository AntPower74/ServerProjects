...
mappa_cambi_completa = {
    'To0270': "■ <b>CAMBIO CON:</b> Alle 11:00 a piazza Carlo Felice <b>CEDE IL BUS a To0310</b> (che parte alle 11:30 per Caselle).",
    'To0310': "■ <b>CAMBIO CON:</b> Alle 11:00 a piazza Carlo Felice <b>RICEVE IL BUS da To0270</b> e cede a <b>To0340</b> alle 15:45.",
    'To0280': "■ <b>CAMBIO CON:</b> Alle 11:45 a piazza Carlo Felice <b>CEDE IL BUS a To0710</b> (che copre la corsa delle 12:30/12:59). Rientro a Grugliasco e smonto alle 12:40.",
    'To0710': "■ <b>CAMBIO CON:</b> Alle 11:45 a piazza Carlo Felice <b>RICEVE IL BUS da To0280</b> e cede a <b>To0650</b> alle 15:40 a Porta Susa.",
    'To0290': "■ <b>CAMBIO CON:</b> Alle 12:15 a piazza Carlo Felice <b>CEDE IL BUS a To0320</b> (che parte alle 12:45 per Caselle).",
    'To0320': "■ <b>CAMBIO CON:</b> Alle 12:15 a piazza Carlo Felice <b>RICEVE IL BUS da To0290</b> e cede a <b>To0360</b> alle 18:15.",
    'To0295': "■ <b>CAMBIO CON:</b> Alle 12:45 a piazza Carlo Felice <b>CEDE IL BUS a To0330</b> (che parte alle 13:00 per Caselle).",
    'To0330': "■ <b>CAMBIO CON:</b> Alle 12:45 a piazza Carlo Felice <b>RICEVE IL BUS da To0295</b> e cede a <b>To0350</b> alle 16:45.",
    'To0300': "■ <b>CAMBIO CON:</b> Alle 13:15 a piazza Carlo Felice <b>CEDE IL BUS a To0330</b> per corsa delle 13:30.",
    'To0340': "■ <b>CAMBIO CON:</b> Alle 15:45 a piazza Carlo Felice <b>RICEVE IL BUS da To0310</b> e cede a <b>To0360</b> alle 21:25.",
    'To0350': "■ <b>CAMBIO CON:</b> Alle 16:45 a piazza Carlo Felice <b>RICEVE IL BUS da To0330</b>.",
    'To0360': "■ <b>CAMBIO CON:</b> Alle 18:15 a piazza Carlo Felice <b>RICEVE IL BUS da To0320</b>. Copre il notturno e rientra a Grugliasco all'01:25.",
    'To0610': "■ <b>CAMBIO CON:</b> Alle 09:30 a Porta Susa (c.so Bolzano) <b>CEDE IL BUS a To0650</b> con auto di servizio.",
    'To0620': "■ <b>CAMBIO CON:</b> Alle 09:30 a Porta Susa (c.so Bolzano) <b>CEDE IL BUS a To0660</b> con auto di servizio.",
    'To0650': "■ <b>CAMBIO CON:</b> Alle 09:30 a Porta Susa <b>RICEVE IL BUS da To0610</b> e cede a <b>To0710</b> alle 15:40.",
    'To0660': "■ <b>CAMBIO CON:</b> Alle 09:30 a Porta Susa <b>RICEVE IL BUS da To0620</b> e cede a <b>To0640</b> alle 17:00.",
    'To0640': "■ <b>CAMBIO CON:</b> Alle 17:00 a Porta Susa <b>RICEVE IL BUS da To0660</b>.",
    'To0700': "■ <b>CAMBIO CON:</b> Alle 12:45 a Porta Susa <b>CEDE IL BUS a To0670</b> con auto di servizio.",
    'To0670': "■ <b>CAMBIO CON:</b> Alle 12:45 a Porta Susa <b>RICEVE IL BUS da To0700</b> e cede a <b>To1040</b> alle 18:30.",
    'To1040': "■ <b>CAMBIO CON:</b> Alle 18:30 a Porta Susa <b>RICEVE IL BUS da To0670</b>.",
    'Ba3520': "■ <b>CAMBIO CON:</b> A Pinerolo Centro Studi alle 08:10 sosta di legge e rientro in linea passeggeri 000280 a Barge.",
    'Pi0140': "■ <b>CAMBIO CON:</b> Turno speciale 40h Lun-Ven continuativo con rientro al Deposito di Pinerolo.",
    'Pi0200': "■ <b>CAMBIO CON:</b> Turno speciale 40h Lun-Ven continuativo con rientro al Deposito di Pinerolo."
}
...
for idx, t in enumerate(tutti_turni):
    ...
    if code == "To0280":
        ...
        box_diff_text = f"• <b>&Delta; Nastro:</b> 0h 00m (Confermato compatto a {p_nastro}) | " \
                        ...
                        f"• <b>NOTA CAMBIO TURNO:</b> Alle 11:45 a piazza Carlo Felice cede il bus a To0710. Rientro a Grugliasco e smonto alle 12:40."
        ...
        # TO0710: MATTINO (04:45 -> 08:39) + RIENTRO A DEPOSITO SENZA PAUSE INVENTATE ALLE 06:00
        corse_prop_puntuali.append(["04:55", "05:10", "Trasf", "TORINO DEPOSITO -> Beinasco"])
        corse_prop_puntuali.append(["05:10", "05:55", "000277", "Beinasco -> AIRASCA SKF (Corsa Operai)"])
        corse_prop_puntuali.append(["05:55", "06:10", "Trasf", "AIRASCA SKF -> Pinerolo Deposito"])
        corse_prop_puntuali.append(["06:56", "07:01", "Trasf", "Pinerolo Deposito -> PINEROLO Movicentro"])
        corse_prop_puntuali.append(["07:06", "08:09", "000275", "PINEROLO Movicentro -> TORINO c.so Bolzano"])
        corse_prop_puntuali.append(["08:09", "08:39", "Trasf", "TORINO c.so Bolzano -> TORINO DEPOSITO"])
        corse_prop_puntuali.append(["08:39", "08:49", "Disp", "Chiusura 1° Spezzone mattutino regolare"])
        p_fine = "08:49 / 15:40"
        p_nastro = "10h 55m"
        p_olg = "7h 24m"
        p_rip = "2"
        ...
        box_diff_text = f"• <b>&Delta; Nastro:</b> Conforme | " \
                        ...
                        f"• <b>&Delta; Riprese:</b> 2 riprese fisiologiche<br/>" \
                        f"• <b>NOTA CAMBIO TURNO:</b> Alle 11:45 riceve il bus da To0280 a Carlo Felice e cede a To0650 alle 15:40 a Porta Susa."
        law_specifica = "• <b>CCNL Autoferrotranvieri (Nastro Max 12h):</b> Nastro &le; 11h00 conforme al limite contrattuale.<br/>" \
                        "• <b>L. 138/1958 Art. 5:</b> Pausa obbligatoria 30m non necessaria nel 1° spezzone in quanto inferiore a 4h00 di guida continuativa.<br/>" \
        ...
        # Per tutti gli altri turni: inseriamo le corse reali senza forzare la pausa di 30m se non necessaria!
        if vere_corse_linea:
    ...
    nota_cambio_turno = mappa_cambi_completa.get(code, f"■ <b>CAMBIO CON:</b> Turno regolare con rientro e smonto nel proprio Deposito di {dep}.")
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO AGGIORNATO CON LA REGOLA DI LEGGE ESATTA SULLE PAUSE (Art. 5 L. 138/58)!")
