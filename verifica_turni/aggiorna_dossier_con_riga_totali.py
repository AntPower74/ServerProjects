...
for idx, t in enumerate(tutti_turni):
    ...
    # Calcolo parametri compatti e valori finali
    if is_40h:
        p_nastro = "8h 05m"
        p_olg = "8h 00m"
        p_rip = "1"
    ...
    # RIGA TOTALI SOTTO TABELLA AZIENDA
    ...
    t_left.setStyle(TableStyle([
        ('SPAN', (0,0), (3,0)),
        ('SPAN', (0,-1), (3,-1)), # SPAN RIGA TOTALI SOTTO
        ('BACKGROUND', (0,0), (-1,0), colors.HexColor('#990000')),
        ('BACKGROUND', (0,1), (-1,1), colors.HexColor('#B30000')),
        ('BACKGROUND', (0,-1), (-1,-1), colors.HexColor('#FFEBEB')), # SFONDO RIGA TOTALI
    ...
    # RIGA TOTALI SOTTO TABELLA PROPOSTA
    ...
    t_right.setStyle(TableStyle([
        ...
        ('BACKGROUND', (0,-1), (-1,-1), colors.HexColor('#E8F5E9') if (is_40h or is_lungo) else colors.HexColor('#EBF3FA')), # SFONDO RIGA TOTALI
...
doc.build(elements)
print("✅ DOSSIER UNIFICATO AGGIORNATO CON RIGA TOTALI SOTTO ENTRAMBE LE TABELLE (OLG, NASTRO, RIPRESE, CONCORSO PASTI)!")
